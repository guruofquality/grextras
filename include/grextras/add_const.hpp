...
#ifndef INCLUDED_GREXTRAS_ADD_CONST_HPP
#define INCLUDED_GREXTRAS_ADD_CONST_HPP
...
{
public:
    typedef boost::shared_ptr<AddConstV> sptr;
...
template <typename type>
void grextras::AddConstV::set_const(const std::vector<type> &val)
{
...
#endif /*INCLUDED_GREXTRAS_ADD_CONST_HPP*/
