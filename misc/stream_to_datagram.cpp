...
static gras::Block *make_stream_to_datagram(const size_t &itemsize, const size_t &mtu)
{
    return new Stream2Datagram(itemsize, mtu);
}

GRAS_REGISTER_FACTORY("/extras/stream_to_datagram", make_stream_to_datagram)
