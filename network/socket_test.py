...
class test_socket_message(unittest.TestCase):
    ...
    def do_loop(self, to_socket, from_socket):
        ...
        s2d = gras.make('/extras/stream_to_datagram', numpy.dtype(numpy.int32).itemsize, 0)
        d2s = gras.make('/extras/datagram_to_stream', numpy.dtype(numpy.int32).itemsize)
    ...
    def test_udp_loopback(self):
        udp_server = gras.make('/extras/socket_message', "UDP_SERVER", 'localhost', '34567', 0)
        udp_client = gras.make('/extras/socket_message', "UDP_CLIENT", 'localhost', '34567', 0)
    ...
    def test_tcp_loopback(self):
        tcp_server = gras.make('/extras/socket_message', "TCP_SERVER", 'localhost', '34567', 0)
        tcp_client = gras.make('/extras/socket_message', "TCP_CLIENT", 'localhost', '34567', 0)
        ...
        tcp_client2 = gras.make('/extras/socket_message', "TCP_CLIENT", 'localhost', '34567', 0)
