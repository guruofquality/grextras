...
class socket_msg(object):
    """Proxy of C++ gnuradio::extras::socket_msg class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    def make(*args, **kwargs):
        """make(string proto, string addr, string port, size_t mtu = 0) -> sptr"""
        return _extras_swig.socket_msg_make(*args, **kwargs)

    make = staticmethod(make)
    __swig_destroy__ = _extras_swig.delete_socket_msg
    __del__ = lambda self : None;
socket_msg_swigregister = _extras_swig.socket_msg_swigregister
socket_msg_swigregister(socket_msg)

def socket_msg_make(*args, **kwargs):
  """socket_msg_make(string proto, string addr, string port, size_t mtu = 0) -> sptr"""
  return _extras_swig.socket_msg_make(*args, **kwargs)
...
class socket_msg_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gnuradio::extras::socket_msg)> class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(self) -> socket_msg_sptr
        __init__(self, socket_msg p) -> socket_msg_sptr
        """
        this = _extras_swig.new_socket_msg_sptr(*args)
        try: self.this.append(this)
        except: self.this = this
    def __deref__(self):
        """__deref__(self) -> socket_msg"""
        return _extras_swig.socket_msg_sptr___deref__(self)

    __swig_destroy__ = _extras_swig.delete_socket_msg_sptr
    __del__ = lambda self : None;
    def make(self, *args, **kwargs):
        """make(self, string proto, string addr, string port, size_t mtu = 0) -> sptr"""
        return _extras_swig.socket_msg_sptr_make(self, *args, **kwargs)
    ...
    def primitive_connect(self, *args):
        ...
        primitive_connect(self, gr_basic_block_sptr src, int src_port, gr_basic_block_sptr dst, 
            int dst_port)
        """
        return _extras_swig.socket_msg_sptr_primitive_connect(self, *args)
    ...
    def primitive_disconnect(self, *args):
        ...
        primitive_disconnect(self, gr_basic_block_sptr src, int src_port, gr_basic_block_sptr dst, 
            int dst_port)
        """
        return _extras_swig.socket_msg_sptr_primitive_disconnect(self, *args)

    def disconnect_all(self):
        """disconnect_all(self)"""
        return _extras_swig.socket_msg_sptr_disconnect_all(self)

    def lock(self):
        """lock(self)"""
        return _extras_swig.socket_msg_sptr_lock(self)

    def unlock(self):
        """unlock(self)"""
        return _extras_swig.socket_msg_sptr_unlock(self)

    def to_hier_block2(self):
        """to_hier_block2(self) -> gr_hier_block2_sptr"""
        return _extras_swig.socket_msg_sptr_to_hier_block2(self)

    def name(self):
        """name(self) -> string"""
        return _extras_swig.socket_msg_sptr_name(self)

    def input_signature(self):
        """input_signature(self) -> gr_io_signature_sptr"""
        return _extras_swig.socket_msg_sptr_input_signature(self)

    def output_signature(self):
        """output_signature(self) -> gr_io_signature_sptr"""
        return _extras_swig.socket_msg_sptr_output_signature(self)

    def unique_id(self):
        """unique_id(self) -> long"""
        return _extras_swig.socket_msg_sptr_unique_id(self)

    def to_basic_block(self):
        """to_basic_block(self) -> gr_basic_block_sptr"""
        return _extras_swig.socket_msg_sptr_to_basic_block(self)

    def check_topology(self, *args, **kwargs):
        """check_topology(self, int ninputs, int noutputs) -> bool"""
        return _extras_swig.socket_msg_sptr_check_topology(self, *args, **kwargs)

socket_msg_sptr_swigregister = _extras_swig.socket_msg_sptr_swigregister
socket_msg_sptr_swigregister(socket_msg_sptr)

socket_msg_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id ())

socket_msg = socket_msg.make
